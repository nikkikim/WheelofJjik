...
if(/Macintosh|Windows/i.test(navigator.userAgent)){
    ...
    isMobile = false;
    document.writeln("<div style='position:fixed;width:100%;height:100%;top:300px;left:0px;background-color:black;'><img style='width:50%;margin:0 auto;display:block;' src='ma.jpg'></div>");
    // window.stop();
}else{
